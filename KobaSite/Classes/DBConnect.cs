...
public class DBConnect
    {
        String SqlConnectString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=KobaSiteDB;Persist Security Info=True;Integrated Security=False;User ID=DBAdmin;Password=Uchiha95;Connect Timeout=15;Encrypt=False;TrustServerCertificate=True;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        ...
        {
            System.Data.DataTable objTable = ds.Tables[0];
